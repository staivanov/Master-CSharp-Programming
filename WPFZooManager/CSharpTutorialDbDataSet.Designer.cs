...
namespace WPFZooManager {
    ...
    public partial class CSharpTutorialDbDataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentRow AddstudentRow(int id, string name, string gender, System.DateTime DOB, int total_score) {
        ...
        public partial class studentRow : global::System.Data.DataRow {
            ...
            public int total_score {
                get {
                    return ((int)(this[this.tablestudent.total_scoreColumn]));
                }
                set {
                    this[this.tablestudent.total_scoreColumn] = value;
                }
            }
        }
...
namespace WPFZooManager.CSharpTutorialDbDataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[student] WHERE (([id] = @Original_id) AND ([name] = @Original_" +
                "name) AND ([gender] = @Original_gender) AND ([DOB] = @Original_DOB) AND ([total_" +
                "score] = @Original_total_score))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[student] ([id], [name], [gender], [DOB], [total_score]) VALUES" +
                " (@id, @name, @gender, @DOB, @total_score);\r\nSELECT id, name, gender, DOB, total" +
                "_score FROM student WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[student] SET [id] = @id, [name] = @name, [gender] = @gender, [DOB] = @DOB, [total_score] = @total_score WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([gender] = @Original_gender) AND ([DOB] = @Original_DOB) AND ([total_score] = @Original_total_score));
SELECT id, name, gender, DOB, total_score FROM student WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WPFZooManager.Properties.Settings.Default.ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, gender, DOB, total_score FROM dbo.student";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_gender, System.DateTime Original_DOB, int Original_total_score) {
            ...
            this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_total_score));
        ...
        public virtual int Insert(int id, string name, string gender, System.DateTime DOB, int total_score) {
            ...
            this.Adapter.InsertCommand.Parameters[4].Value = ((int)(total_score));
        ...
        public virtual int Update(int id, string name, string gender, System.DateTime DOB, int total_score, int Original_id, string Original_name, string Original_gender, System.DateTime Original_DOB, int Original_total_score) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(total_score));
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((int)(Original_total_score));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string gender, System.DateTime DOB, int total_score, int Original_id, string Original_name, string Original_gender, System.DateTime Original_DOB, int Original_total_score) {
            return this.Update(Original_id, name, gender, DOB, total_score, Original_id, Original_name, Original_gender, Original_DOB, Original_total_score);
        }
    }
